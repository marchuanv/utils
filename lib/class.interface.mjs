    ...
    */
    constructor(classInterfaceConfig, targetClass) {
        ...
        if (classExtDepConfigurations.length !== classExtends.length) {
            const { className } = classInterfaceConfig;
            throw new Error(`class and class config mismatch, not all class extends, i.e. dependencies are configured in ${className.toLowerCase()}.interface.json`);
        }
