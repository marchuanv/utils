...
export class State extends UUID {
    ...
    */
    constructor(stateName) {
        super(stateName);
        if (UUIDMap.hasKey(this)) {
            const stateUUID = UUIDMap.getKey(this);
            return privateBag.get(stateUUID);
        } else {
            const stateUUID = UUIDMap.createKey(this);
            privateBag.set(stateUUID, this);
            Object.freeze(this);
        }
    }
    /**
    ...
    */
    static get HYDRATE() {
        return new State('HYDRATE');
    }
    /**
     * @returns { State }
    */
    static get REHYDRATE() {
        return new State('REHYDRATE');
    }
    /**
     * @returns { State }
    */
    static get CONSTRUCT() {
        return new State('CONSTRUCT');
    }
    /**
     * @returns { State }
    */
...
export class Bag extends UUID {
    ...
    */
    static setProperty(bag, secureContext, property) {
        if (!Bag.hasProperty(bag, secureContext)) {
    ...
    */
    static getProperty(bag, secureContext, property) {
        if (!Bag.hasProperty(bag, secureContext, property)) {
            const propertyName = Object.keys(property)[0];
    ...
    */
    static setState(bag, secureContext, state) {
        ...
        if (!(state instanceof State)) {
            throw new Error(`The state argument is not an instance of ${State.name}`);
        }
        const { stateUUID } = getPrivateBagKeys(bag, secureContext);
...
function hasPrivateBagKeys(bag, secureContext, privateBagKeys = {}) {
    ...
    if (UUIDMap.hasKey([bag, secureContext])) {
        ...
        if (stateUUID !== undefined) {
            const globalStateId = new UUID('ccaca85f-2173-43fa-83cd-0f3969bc734c');
            isValid = UUIDMap.hasKey([secureBagUUID, globalStateId]);
        }
        if (propertiesUUID !== undefined) {
            const globalPropertiesId = new UUID('3461b1a0-6172-4f7d-af53-cdba9e05637a');
            isValid = UUIDMap.hasKey([secureBagUUID, globalPropertiesId]);
        }
    }
    return isValid;
}
...
function deletePrivateBagKeys(bag, secureContext) {
    ...
    UUIDMap.delete([secureBagUUID, globalStateId]);
    UUIDMap.delete([secureBagUUID, globalPropertiesId]);
}