...
export class Type extends DataSchema {
    ...
    */
    constructor(name = UNKNOWN.name, func = UNKNOWN) {
        ...
        this._typePropId = new UUID(null, secureContext);
        Bag.set(this._typePropId, secureContext, new Properties([
    ...
    */
    get name() {
        const { name } = Bag.get(this._typePropId, secureContext, Type.prototype);
        return name;
    }
    /**
     * @returns { Function }
    */
    get func() {
        const { func } = Bag.get(this._typePropId, secureContext, Type.prototype);
        return func;
    }
    /**
     * @returns { Boolean }
    */
    get isArray() {
        const { isArray } = Bag.get(this._typePropId, secureContext, Type.prototype);
        return isArray;
    }
}