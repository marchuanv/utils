...
export class Type extends DataSchema {
    ...
    */
    get name() {
        const { name } = Bag.get(this._propertiesId, secureContext, Type.prototype);
        return name;
    }
    /**
     * @returns { Function }
    */
    get func() {
        const { func } = Bag.get(this._propertiesId, secureContext, Type.prototype);
        return func;
    }
    /**
     * @returns { Boolean }
    */
    get isArray() {
        const { isArray } = Bag.get(this._propertiesId, secureContext, Type.prototype);
        return isArray;
    }
}