    ...
    */
    constructor(targetType, isStatic = false) {
        ...
        if (Bag.hasUUID(this._typeId, secureContext)) {
            ...
            return Bag.getProperty(this._typeId, secureContext, { isClass: null });
            return Bag.getProperty(this._typeId, secureContext, { members: null });
            return Bag.getProperty(this._typeId, secureContext, { defaultValue: null });
        ...
        Bag.setProperty(this._typeId, secureContext, membersProperty);
        const isClass = Reflection.isClass(super.func);
        let defaultValue = UNKNOWN;
        Bag.setProperty(this._typeId, secureContext, new Property('isClass', isClass));
        if (isClass) {
            if (isStatic) {
                ...
                defaultValue = {};
                for (const { memberKey, typeInfo: { defaultValue } } of membersProperty.value) {
                    defaultValue[memberKey] = defaultValue;
                }
            }
        } else {
            switch (super.func) {
        ...
        Bag.setProperty(this._typeId, secureContext, new Property('defaultValue', defaultValue));
        Object.freeze(this);
    }
    /**
     * @returns { Boolean }
