import { Container, Member, MemberParameter, MethodMember, PropertyMember, randomUUID } from "../../registry.mjs";
...
export class ClassMember extends Member {
    ...
    */
    constructor(Class) {
        super();
        super.update(Class.name, true, false, false, false, false, false, false, Class, []);
