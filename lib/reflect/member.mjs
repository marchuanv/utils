import { MemberParameter, PrimitiveType, ReferenceType, TypeMapper, randomUUID } from "../../registry.mjs";
export class Member {
    /**
     * @param { String } name
     ...
     * @returns { Member }
    */
    update(name, isClass, isProperty, isMethod, isStatic, isCtor, isGetter, isSetter, map, parameters) {
        this._Id = randomUUID();
        this._name = name;
        this._children = [];
        this._index = -1;
    ...
    */
    ...
    /**
     * @returns { ReferenceType | PrimitiveType }
    */
    get map() {
        return this._map;
    }
