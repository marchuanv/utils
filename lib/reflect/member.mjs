import { ComplexType, MemberParameter, PrimitiveType, randomUUID } from "../../registry.mjs";
export class Member {
    /**
     * @param { String } name
     ...
     * @param { ComplexType | PrimitiveType } type
     * @param { Array<MemberParameter> } parameters
     * @returns { Member }
    */
    update(name, isClass, isProperty, isMethod, isStatic, isCtor, isGetter, isSetter, type, parameters) {
        this._Id = randomUUID();
        this._name = name;
        this._children = [];
        this._index = -1;
