...
export class TypeMapper {
    ...
    static getReferenceType(ref) {
        if (TypeMapper.isRegistered(ref)) {
            ...
            if ((ref && typeof ref === 'string' && (ref === 'array' || ref.indexOf('array<') > -1))) {
                ...
                ({ refType, isArray, Id } = registry.find(t => t.refType === ref || t.refType.name === ref || (t.refType.name && t.refType.name.toLowerCase() === ref)));
            }
    ...
    */
    static isRegistered(ref) {
        ...
        return registry.find(t => t.refType === ref || t.refType.name === ref || (t.refType.name && t.refType.name.toLowerCase() === ref));
    }
}
...
const guidId = new GUID();
TypeMapper.register(guidId, GUID, true);