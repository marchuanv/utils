...
export class Reflection {
    ...
    */
    ...
    /**
     * @param { class } Class
     * @returns { Array<{ Id: String, Class: class, name: String, isMethod: Boolean, isProperty: Boolean, isGetter: Boolean, isSetter: Boolean }> }
    */
    ...
    */
     ...
     * @returns { { Class: class, name: String, isGetter: Boolean, isSetter: Boolean, propertyType: class } | undefined }
    */
    static getClassProperty(Class, propertyName, beforeConditions = [], afterConditions = []) {
        ...
        if (found) {
            const { name, isGetter, isSetter, Id } = found;
