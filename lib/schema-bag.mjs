...
/**
 * This class provides functionality to create a bag that is unique to a GUID schema. Compatibility with RFC-4122 standards.
*/
    ...
    */
    constructor(secureContext, schema = new GUIDSchema()) {
        ...
        if (Bag.hasKey(this.IdStr, secureContext)) {
            ...
            return Bag.get(bagKey, Class);
        } else {
            Bag.set(this.IdStr, this, schema, secureContext);
        }
    }
    /**
