import { PrimitiveType, ReferenceType, TypeMapper, VERBOSE, addSchema, validateSchema } from "../registry.mjs";
const schemas = [];
    ...
    create() {
        ...
        if (!schemaExists(classId, typeName)) {
            ...
            const properties = parameters.reduce((prop, param) => {
                let definition = {};
                const { nativeType, isArray } = param.type;
                ...
                if (!schemaExists(classId, param.name) && nativeType === Object) {
                    ...
                    const isReferenceType = param.type instanceof ReferenceType;
                    const isPrimitiveType = param.type instanceof PrimitiveType;
                    ...
                    } else if (referenceType && referenceType.type === nativeType) {
