import { TypeMapper, VERBOSE, addSchema, validateSchema } from "../registry.mjs";
const schemas = [];
...
export class Schema {
    ...
    create() {
        ...
        let targetClass = container.interface;
        const memberParameters = container.interface.ctor.parameters;
        const { Id: classId, name: typeName } = targetClass;
