...
export class Serialiser extends Container {
    ...
    */
    constructor(args, targetClass, baseClass) {
                ...
                const classMembers = [];
                {
                    ...
                    while(classMember.next) {
                        if (classMember.child instanceof ClassMember) {
                            ...
                            if (classMember && classMember.type !== Container && classMember.type !== baseClass) {
                                classMembers.push(classMember);
                            }
                        }
                    }
     ...
     * @returns { T }
    */
    static async deserialise(data, targetClass, baseClass) {
        ...
        const serialiser = new Serialiser(_args, targetClass, baseClass);
