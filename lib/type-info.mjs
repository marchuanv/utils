...
export class TypeInfo {
    ...
    */
    constructor(type, isStatic = false) {
        if (!Bag.hasSchema(TypeInfoSchema)) {
            new TypeInfoSchema();
        }
        ...
        this._Id = new UUID(`${type.name}-info`);
        if (Bag.has(this._Id, secureContext)) {
            return Bag.get(this._Id, secureContext, TypeInfo.prototype);
        }
        ...
        Bag.set(this._Id, secureContext, this, TypeInfo, TypeInfoSchema);
        Bag.setData(this._Id, secureContext, properties, TypeInfo);
        Object.freeze(this);
    }
    /**
    ...
    */
    get type() {
        const { type } = Bag.getData(this.Id, secureContext, TypeInfo);
        return type;
    }
    /**
     * @returns { Boolean }
    */
    get isClass() {
        const { isClass } = Bag.getData(this.Id, secureContext, TypeInfo);
        return isClass;
    }
    /**
    ...
    */
    get members() {
        const { members } = Bag.getData(this.Id, secureContext, TypeInfo);
        return members;
    }
    /**
     * @returns { Object, NULL }
    */
    get defaultValue() {
        const { defaultValue } = Bag.getData(this.Id, secureContext, TypeInfo);
        return defaultValue;
    }
}