...
export class Type {
    ...
    */
    constructor(name = UNKNOWN.name, func = UNKNOWN) {
        ...
        if (Bag.has(this._Id, secureContext)) {
            ...
            Bag.set(this._Id, secureContext, this, Type, TypeSchema);
            Bag.setData(this._Id, secureContext, { name: _funcName, func: _func, isArray }, Type);
        }
        Object.freeze(this);
    }
    /**
    ...
    */
    get name() {
        const { name } = Bag.getData(this.Id, secureContext, Type);
        return name;
    }
    /**
     * @returns { Function }
    */
    get func() {
        const { func } = Bag.getData(this.Id, secureContext, Type);
        return func;
    }
    /**
     * @returns { Boolean }
    */
    get isArray() {
        const { isArray } = Bag.getData(this.Id, secureContext, Type);
        return isArray;
    }
}
