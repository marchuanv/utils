function Utils(references){
    ...
    const {setTimeout, setInterval,clearInterval} = references;
    
    this.wait=function(cbInterval, intervalsInMilliseconds, timeoutInMilliseconds){
        const interval = setInterval(() => {
            cbInterval(() => clearInterval(interval));
