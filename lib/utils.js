function Utils(){
  ...
  this.getRemainingDays = (year, month) =>{
    ...
    console.log("Last Day In Month: ", lastDayOfSelectedMonth);
    console.log("Current Date: ", currentDate);
    console.log("New Date: ", newDate);

    return Math.round(Math.abs((newDate.getTime() - currentDate.getTime())/(oneDay))) + currentDay;
  }
}
