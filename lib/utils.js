function Utils(references){
    ...
    const {setTimeout, setInterval, clearInterval, console, Buffer} = references;
    ...
    this.wait=function(intervalsInMilliseconds, timeoutInMilliseconds, cbInterval, cbTimeout){
