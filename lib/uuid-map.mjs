...
export class UUIDMap {
    ...
    */
    static hasKey(uuids) {
        ...
        return uuIdMap.has(compositeKey.toString());
    }
    /**
     * @param { Array<UUID | String> |  UUID | String } uuids
     * @returns { UUID }
    */
    static getKey(uuids) {
        ...
        const compositeKey = getCompositeKey(uuids);
        return uuIdMap.get(compositeKey.toString());
    }
    /**
     * @param { Array<UUID | String> |  UUID | String } uuids
     * @returns { UUID }
    ...
    */
    static delete(uuids) {
        ...
        const compositeKey = getCompositeKey(uuids);
        uuIdMap.delete(compositeKey.toString());
    }
}
/**
...
function getCompositeKey(uuids) {
    ...
    if (_uuids.find(x => x === null || x === undefined)) {
        throw new Error(`one or more uuid's are null or undefined.`);
    }
